...
import FoodItemnew from "../components/FoodItemnew";
    ...
    <>
      <ScrollView style={{ marginTop: 50 }}>
        ...
        {route.params.menu.map((item, index) => (
          <FoodItemnew item={item} key={index} />
        ))}
      </ScrollView>
      <Pressable
        onPress={toggleModal}
      ...
      {/* if total = 0 show null otherwise shoe Pressable with green color */}
      {total == 0 ? null : (
        <Pressable
          style={{
        ...
        >
          <View style={{flexDirection:"row",alignItems:"center",justifyContent:"space-between"}}>
            <View>
              ...
              <Text
                style={{ fontSize: 14, fontWeight: "500",marginTop:3, color: "white" }}
              >
            ...
            <Pressable onPress={() => navigation.navigate("Cart",{
              ...
              <Text style={{ fontSize: 18, fontWeight: "500",  color: "white" }}>View Cart</Text>
            </Pressable>
          </View>
        </Pressable>
      )}
